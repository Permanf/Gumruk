    ...
    <Layout title="Hyzmatlar" className="bg_gray">
      ...
      <div className="w-full flex flex-col items-center">
        {data?.map((item) => {
          return (
            <>
              <div className="container_md flex flex-col items-start my-4 mt-8">
                <p className="font-semibold text-4xl text-blue-700">
                  {item.title}
                </p>
                <span className="text-gray-400 text-md w-96 mt-4">
                  {item.description}
                </span>
              </div>
              {item?.sub_data?.map((sub, index) => {
                return (
                  <div
                    key={`sub${index}`}
                    className="container_md bg-white rounded-lg my-5 px-10 py-5 shadow-md"
                  >
                    <div className="w-full flex justify-between py-3">
                      <div className="w-1/3">
                        <p className="font-semibold text-base">{sub.title}</p>
                      </div>
