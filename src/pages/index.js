    ...
    <Layout title="Home">
      ...
      <div className="w-ful flex justify-center bg_blue text-white py-10">
        <div className="container_md flex flex-col">
          ...
          <span className="text-sm w-96 mt-3">
          ...
          <Button
            ...
            radius="md"
            size="md"
            className="bg-white w-40 my-4 hover:text-white"
          >
            Hasaba almak
          </Button>
          <div
      ...
      <div className="w-full bg_gray flex justify-center">
        <div className="container_out flex flex-col -mt-20">
          {service?.map((item, index) => {
            return (
              <div
                key={`service${index}`}
                className="w-full bg-white rounded-lg my-5 p-10  cursor-pointer shadow-md"
              >
                <div className="w-full flex justify-between items-center py-3">
                  ...
                  <span className="text-xs w-60">{item?.description}</span>
                  <Icon
                    size={25}
                    icon={arrowRight2}
      ...
      <div className="flex justify-center bg_gray py-20">
        <div
      ...
      <div className="flex flex-col items-center py-10 bg_gray">
        <div className="container_out flex justify-between mb-4">
          <h1 className="font-bold text-4xl mb-4 text-blue-600">Новости</h1>
          <Button
            variant="outline"
            radius="md"
            size="md"
